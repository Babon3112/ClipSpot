...
const createPlaylist = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, playlist, "Create playlist success"));
});
...
const getUserPlaylists = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, playlists, "Get user playlists success"));
});
...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, {}, "Add video to playlist success"));
});
...
const removeVideoFromPlaylist = asyncHandler(async (req, res) => {
  ...
  playlist.videos = playlist.videos.filter(
    (v) => v.toString() !== videoId.trim()
  );
  await playlist.save();

  res
    .status(200)
    .json(new ApiResponse(200, {}, "Remove video from playlist success"));
});
